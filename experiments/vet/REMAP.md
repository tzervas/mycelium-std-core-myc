# Remap Manifest — mycelium-std-core → std.core
...
|---|---|---|---|---|---|---|
| `std.core.error_scaffold` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-std-core/src/error_scaffold.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
| `std.core` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-std-core/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
